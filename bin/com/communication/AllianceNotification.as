package com.communication {
	...
	public dynamic final class AllianceNotification extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const ALLIANCE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.communication.AllianceNotification.alliance", "alliance", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.communication.Alliance; });

		public var alliance:com.communication.Alliance;
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++alliance$count;
					this.alliance = new com.communication.Alliance();
