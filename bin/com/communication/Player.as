package com.communication {
	...
	public dynamic final class Player extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const USER:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.communication.Player.user", "user", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.communication.User; });

		public var user:com.communication.User;

		/**
		 *  @private
		 */
		public static const COLOR:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.communication.Player.color", "color", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ISPLAYEDMOVE:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("com.communication.Player.isPlayedMove", "isPlayedMove", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CARDS:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("com.communication.Player.cards", "cards", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NUMBEROFREINFORCMENTS:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.communication.Player.numberOfReinforcments", "numberOfReinforcments", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					...
					++user$count;
					this.user = new com.communication.User();
