package communication.protos {
	...
	public dynamic final class MoveUnitsResponse extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const COMMAND:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("communication.protos.MoveUnitsResponse.command", "command", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return communication.protos.Command; });
