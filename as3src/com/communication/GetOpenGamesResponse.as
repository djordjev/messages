package com.communication {
	...
	public dynamic final class GetOpenGamesResponse extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GAMEDESCRIPTION:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("com.communication.GetOpenGamesResponse.gameDescription", "gameDescription", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.communication.GameDescription; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				switch (tag >> 3) {
				case 1:
					this.gameDescription.push(com.netease.protobuf.ReadUtils.read$TYPE_MESSAGE(input, new com.communication.GameDescription()));
					break;
				default:
