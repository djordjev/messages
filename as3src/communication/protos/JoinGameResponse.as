package communication.protos {
	...
	public dynamic final class JoinGameResponse extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GAMECONTEXT:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("communication.protos.JoinGameResponse.gameContext", "gameContext", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return communication.protos.GameContext; });
