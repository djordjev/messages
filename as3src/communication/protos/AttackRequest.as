package communication.protos {
	...
	public dynamic final class AttackRequest extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const GAMEID:FieldDescriptor$TYPE_INT64 = new FieldDescriptor$TYPE_INT64("communication.protos.AttackRequest.gameId", "gameId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 2:
					if (gameId$count != 0) {
						throw new flash.errors.IOError('Bad data format: AttackRequest.gameId cannot be set twice.');
					}
					++gameId$count;
